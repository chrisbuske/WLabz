...
namespace WLabz.api.accounts.current.Controllers
{
    ...
    [ApiController]
    public class AvailableBalanceController : ControllerBase
    {
        #region Declarations...
        ...
        public AvailableBalanceController(IFluentHibernateSessionManager persistance)
        {
        ...
        /// <summary>
        /// Retrieve the current balance for a current account...
        /// </summary>
        ...
        public async Task<decimal> Get(long accountNumber)
        {
            ...
            try
            {
                ...
                if (overdraft == null || overdraft.OverdraftStatus != Model.Overdraft.OverdraftStatuses.Active)
                    return balance.CurrentBalance(transactionTypes);
                else
                    return decimal.Multiply(decimal.Subtract(overdraft.OverdraftAmount,balance.CurrentBalance(transactionTypes)), -1);
